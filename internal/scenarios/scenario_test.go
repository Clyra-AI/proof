...
func runScenario(t *testing.T, binary, dir string) {
	...
	case "action-contract-lifecycle-conformance":
		...
		computedRecordsDigest := "sha256:" + hex.EncodeToString(sum[:])
		require.Equal(t, "sha256:da43d8266cce75cabc13baecdbe82e2db5fd979fd6624a41eaf5f2fdf6c3d100", computedRecordsDigest)
		require.Equal(t, computedRecordsDigest, manifest.Records.SHA256)
